...
app.post("/Webhook", (req, res) => {
  if (req.headers["x-hook-secret"]) {
      ...
      console.log(req.body.events);
        ...
        await fetch(`https://app.asana.com/api/1.0/tasks/${kar_id}`, {
          ...
          .then((dataGet) => {
            ...
            const apiKey =
              "pat7GtRy8QXDTF6fU.43b2fb935c9249403959c9178f58757e17a5a94447af5671dac93c61cfcd9e8a"; 
            ...
            if (
              ...
              async function fetchData(gettingData, url, headers) {
                await fetch(url, {
                  ...
                  .then((data) => {
                    console.log("All Records added", data);
                  })
                  .catch((error) => {
                    console.error("Error adding in records:", error);
                  });
              }
    ...
    console.error("Something is wrong check it!");
  }
});
app.listen(3000, () => {
